...
public class TextAnalyzerPipeline {
...
//        }
    ...
    for (CoreLabel rawWord: s.get(CoreAnnotations.TokensAnnotation.class)) {
            ...
            w.setNerTag(rawWord.get(CoreAnnotations.NamedEntityTagAnnotation.class));
    ...
    public static void main (String[] args){
        ...
        TextAnalyzerPipeline a = new TextAnalyzerPipeline();
